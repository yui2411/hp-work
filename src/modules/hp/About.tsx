    ...
    <Box className="About" sx={sx}>
      <Box className="About-title-group">
        <Box className="About-title">
          <span className="About-title-color">A</span>BOUT
        </Box>
      ...
      <Box className="About-group">
        ...
        <Box className="About-textgroup">
          <Box className="About-text">
            副業人材を主体とした
            <span className="About-color">「 業務委託サービス」</span>です。
            <br className="About-br" />
            通常では人材派遣の市場に出てこないような大企業に勤めているベテランのエンジニアや開発の中核を担う
            <br className="About-br" />
            フリーランスエンジニアが
            <span className="About-color">現在約100名</span>ほど所属しています。
            <br />
            <br />
